...
public static class ServiceRegistration
{
    public static void AntFlowServiceSetUp(this IServiceCollection services,IConfiguration configuration)
    {
        ...
        services.AddSingleton<IBpmAfDeploymentRepository, SsBpmAfDeploymentRepository>();
        services.AddSingleton<IBpmAfTaskInstRepository, SsBpmAfTaskInstRepository>();
        services.AddSingleton<IBpmBusinessProcessRepository, SsBpmBusinessProcessRepository>();
        services.AddSingleton<IBpmFlowrunEntrustRepository, SsBpmFlowrunEntrustRepository>();
        services.AddSingleton<IAFTaskRepository, SsAFTaskRepository>();
        services.AddSingleton<IBpmnConfLfFormdataFieldRepository, SsBpmnConfLfFormdataFieldRepository>();
        services.AddSingleton<IBpmnConfLfFormdataRepository, SsBpmnConfLfFormdataRepository>();
        services.AddSingleton<IBpmnConfNoticeTemplateDetailRepository, SsBpmnConfNoticeTemplateDetailRepository>();
        services.AddSingleton<IBpmnConfNoticeTemplateRepository, SsBpmnConfNoticeTemplateRepository>();
        services.AddSingleton<IBpmnNodeAdditionalSignConfRepository, SsBpmnNodeAdditionalSignConfRepository>();
        services.AddSingleton<IBpmnNodeRepository, SsBpmnNodeRepository>();
        services.AddSingleton<IBpmProcessForwardRepository, SsBpmProcessForwardRepository>();
        services.AddSingleton<IBpmProcessNameRelevancyRepository, SsBpmProcessNameRelevancyRepository>();
        services.AddSingleton<IBpmProcessNameRepository, SsBpmProcessNameRepository>();
        services.AddSingleton<IBpmProcessNodeSubmitRepository, SsBpmProcessNodeSubmitRepository>();
        services.AddSingleton<IBpmVerifyInfoRepository, SsBpmVerifyInfoRepository>();
        services.AddSingleton<ILFMainFieldRepository, SsLFMainFieldRepository>();
        services.AddSingleton<ILFMainRepository, SsLFMainRepository>();
        services.AddSingleton<IBpmnConfRepository, SsBpmnConfRepository>();
        services.AddSingleton<IBpmVariableRepository, SsBpmVariableRepository>();
        services.AddSingleton<IOutSideBpmAccessBusinessRepository, SsOutSideBpmAccessBusinessRepository>();
        services.AddSingleton<IOutSideBpmCallbackUrlConfRepository, SsOutSideBpmCallbackUrlConfRepository>();
        services.AddSingleton<IOutSideBpmBusinessPartyRepository, SsOutSideBpmBusinessPartyRepository>();
        services.AddSingleton<IOutSideBpmAdminPersonnelRepository, SsOutSideBpmAdminPersonnelRepository>();
        services.AddSingleton<IOutSideBpmConditionsTemplateRepository, SsOutSideBpmConditionsTemplateRepository>();
        services.AddSingleton<IBpmProcessAppApplicationRepository, SsBpmProcessAppApplicationRepository>();
        services.AddSingleton<IBpmnNodeConditionsConfRepository, SsBpmnNodeConditionsConfRepository>();
        services.AddSingleton<IBpmnNodeConditionsParamConfRepository, SsBpmnNodeConditionsParamConfRepository>();
        services.AddSingleton<IBpmnNodeCustomizeConfRepository, SsBpmnNodeCustomizeConfRepository>();
        services.AddSingleton<IBpmnNodeHrbpConfRepository, SsBpmnNodeHrbpConfRepository>();
        services.AddSingleton<IBpmnNodeLfFormdataFieldControlRepository, SsBpmnNodeLfFormdataFieldControlRepository>();
        services.AddSingleton<IBpmnNodeLoopConfRepository, SsBpmnNodeLoopConfRepository>();
        services.AddSingleton<IBpmnNodeOutSideAccessConfRepository, SsBpmnNodeOutSideAccessConfRepository>();
        services.AddSingleton<IBpmnNodePersonnelConfRepository, SsBpmnNodePersonnelConfRepository>();
        services.AddSingleton<IBpmnNodePersonnelEmplConfRepository, SsBpmnNodePersonnelEmplConfRepository>();
        services.AddSingleton<IBpmnNodeRoleConfRepository, SsBpmnNodeRoleConfRepository>();
        services.AddSingleton<IBpmnNodeRoleOutsideEmpConfRepository, SsBpmnNodeRoleOutsideEmpConfRepository>();
        services.AddSingleton<IBpmnNodeSignUpConfRepository, SsBpmnNodeSignUpConfRepository>();
        services.AddSingleton<IBpmnNodeToRepository, SsBpmnNodeToRepository>();
        services.AddSingleton<IBpmnViewPageButtonRepository, SsBpmnViewPageButtonRepository>();
        services.AddSingleton<IUserEntrustRepository, SsUserEntrustRepository>();
        services.AddSingleton<IBpmnApproveRemindRepository, SsBpmnApproveRemindRepository>();
        services.AddSingleton<IBpmnTemplateRepository, SsBpmnTemplateRepository>();
        services.AddSingleton<IBpmProcessNoticeRepository, SsBpmProcessNoticeRepository>();
        services.AddSingleton<IDefaultTemplateRepository, SsDefaultTemplateRepository>();
        services.AddSingleton<IDicMainRepository, SsDicMainRepository>();
        services.AddSingleton<IInformationTemplateRepository, SsInformationTemplateRepository>();
        services.AddSingleton<IOutSideBpmApproveTemplateRepository, SsOutSideBpmApproveTemplateRepository>();
        services.AddSingleton<IRoleRepository, SsRoleRepository>();
        services.AddSingleton<IUserMessageRepository, SsUserMessageRepository>();
        services.AddSingleton<IUserMessageStatusRepository, SsUserMessageStatusRepository>();
        services.AddSingleton<IUserRepository, SsUserRepository>();
        services.AddSingleton<IBpmnNodeAssignLevelConfRepository, SsBpmnNodeAssignLevelConfRepository>();
        services.AddSingleton<IBpmnNodeBusinessTableConfRepository, SsBpmnNodeBusinessTableConfRepository>();
        services.AddSingleton<IBpmnNodeButtonConfRepository, SsBpmnNodeButtonConfRepository>();
        services.AddSingleton<IBpmnNodeConditionsParamConfRepository, SsBpmnNodeConditionsParamConfRepository>();
        services.AddSingleton<IBpmVariableApproveRemindRepository, SsBpmVariableApproveRemindRepository>();
        services.AddSingleton<IBpmVariableButtonRepository, SsBpmVariableButtonRepository>();
        services.AddSingleton<IBpmVariableMessageRepository, SsBpmVariableMessageRepository>();
        services.AddSingleton<IBpmVariableMultiplayerPersonnelRepository, SsBpmVariableMultiplayerPersonnelRepository>();
        services.AddSingleton<IBpmVariableMultiplayerRepository, SsBpmVariableMultiplayerRepository>();
        services.AddSingleton<IBpmVariableSequenceFlowRepository, SsBpmVariableSequenceFlowRepository>();
        services.AddSingleton<IBpmVariableSignUpRepository, SsBpmVariableSignUpRepository>();
        services.AddSingleton<IBpmVariableSingleRepository, SsBpmVariableSingleRepository>();
        services.AddSingleton<IBpmVariableViewPageButtonRepository, SsBpmVariableViewPageButtonRepository>();
        services.AddSingleton<IBpmVariableSignUpPersonnelRepository, SsBpmVariableSignUpPersonnelRepository>();
        services.AddSingleton<IBpmAfExecutionRepository, SsBpmAfExecutionRepository>();
        services.AddSingleton<IBpmnConfNoticeTemplateDetailService, BpmnConfNoticeTemplateDetailService>();
        services.AddSingleton<IDepartmentRepository, SsDepartmentRepository>();
        services.AddSingleton<IThirdPartyAccountApplyRepository, SsThirdPartyAccountApplyRepository>();
        //=================================不可越过的三八线==============================
