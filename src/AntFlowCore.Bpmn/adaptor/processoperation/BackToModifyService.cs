...
public class BackToModifyService : IProcessOperationAdaptor
    {
        ...
        private readonly IProcessBusinessContansService _processConstants;
        ...
        public BackToModifyService(
            ...
            IBpmProcessNodeSubmitService processNodeSubmitService,
            ...
            IProcessBusinessContansService processConstants)
        {
        ...
        public void SetSupportBusinessObjects()
        {
            ...
            ((IAdaptorService)this).AddSupportBusinessObjects(ProcessOperationEnum.BUTTON_TYPE_PROCESS_DRAW_BACK);
