...
public class BpmnSendMessageAspect<T> : DispatchProxy
{
    ...
    protected override object Invoke(MethodInfo targetMethod, object[] args)
    {
        ...
        IBpmnConfCommonService bpmnConfCommonService = ServiceProviderUtils.GetService<IBpmnConfCommonService>();
    ...
    private void DoMethod( BpmnConf bpmnConf, BusinessDataVo businessDataVo, OutSideBpmBusinessParty outSideBpmBusinessParty,
        ...
        if (bpmnConf.IsOutSideProcess == 1 && !businessDataVo.IsOutSideChecked) {
            ...
            IOutSideBpmCallbackUrlConfService outSideBpmCallbackUrlConfService = ServiceProviderUtils.GetService<IOutSideBpmCallbackUrlConfService>();
