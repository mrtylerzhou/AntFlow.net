...
public class BpmnConfCommonService : IBpmnConfCommonService
{
    ...
    private readonly IBpmnRemoveConfFormatFactory _bpmnRemoveConfFormatFactory;
    private readonly IBpmnNodeFormatService _bpmnNodeFormatService;
    ...
    public BpmnConfCommonService(
        ...
        IBpmnRemoveConfFormatFactory bpmnRemoveConfFormatFactory,
        IBpmnNodeFormatService bpmnNodeFormatService,
