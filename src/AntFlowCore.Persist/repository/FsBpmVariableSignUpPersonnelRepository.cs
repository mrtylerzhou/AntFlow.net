...
public class FsBpmVariableSignUpPersonnelRepository : RepositoryBase<BpmVariableSignUpPersonnel>, IBpmVariableSignUpPersonnelRepository
{
    public FsBpmVariableSignUpPersonnelRepository(AntFlowOrmContext context) : base(context)
    {
    }
    ...
    {
        List<BpmVariableSignUp> bpmVariableSignUps = _ormContext.FreeSql.Select<BpmVariable, BpmVariableSignUp>()
        ...
        _ormContext.FreeSql.Insert(bpmVariableSignUpPersonnels).ExecuteAffrows();
    }

    public List<KeyValuePair<string, string>> GetSignUpNodeAssigneeMap(string procInstId, string elementId)
    {
        List<KeyValuePair<string, string>> signupNodeAssigneeMap = _ormContext.FreeSql
