...
public class PrevEmployeeInfo
{
    ...
    [JsonPropertyName("jobLevelId")] public long? JobLevelId { get; set; }

    [JsonPropertyName("jobLevel")] public string JobLevel { get; set; }

    [JsonPropertyName("departName")] public string DepartName { get; set; }

    [JsonPropertyName("departId")] public int? DepartId { get; set; }
}