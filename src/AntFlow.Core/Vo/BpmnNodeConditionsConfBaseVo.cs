...
public class BpmnNodeConditionsConfBaseVo
{
    ...
    [JsonPropertyName("groupRelation")] public int? GroupRelation { get; set; }
    ...
    [JsonPropertyName("parkArea")] public double? ParkArea { get; set; }

    [JsonPropertyName("accountType")] public List<int> AccountType { get; set; }

    [JsonPropertyName("accountTypeList")] public List<BaseIdTranStruVo> AccountTypeList { get; set; }

    [JsonPropertyName("planProcurementTotalMoney")]
    public double? PlanProcurementTotalMoney { get; set; }

    [JsonPropertyName("purchaseType")] public List<int> PurchaseType { get; set; }

    [JsonPropertyName("purchaseTypeList")] public List<BaseIdTranStruVo> PurchaseTypeList { get; set; }

    [JsonPropertyName("totalMoney")] public string TotalMoney { get; set; }

    [JsonPropertyName("outTotalMoney")] public string OutTotalMoney { get; set; }

    [JsonPropertyName("leaveHour")] public double? LeaveHour { get; set; }

    [JsonPropertyName("numberOperator")] public int? NumberOperator { get; set; }

    [JsonPropertyName("numberOperatorList")]
    public List<int> NumberOperatorList { get; set; } = new();
    ...
    [JsonPropertyName("extJson")] public string ExtJson { get; set; }
    ...
    [JsonPropertyName("outSideMatched")] public bool? OutSideMatched { get; set; }

    [JsonPropertyName("templateMarks")] public List<int> TemplateMarks { get; set; }

    [JsonPropertyName("lfConditions")] public IDictionary<string, object> LfConditions { get; set; }
