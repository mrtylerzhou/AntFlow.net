...
public class OutSideBpmApproveTemplateVo
{
    ...
    [JsonPropertyName("businessPartyId")] public long? BusinessPartyId { get; set; }

    [JsonPropertyName("applicationId")]
    [JsonConverter(typeof(StringToIntConverter))]
    public int? ApplicationId { get; set; }

    [JsonPropertyName("approveTypeId")] public int? ApproveTypeId { get; set; }

    [JsonPropertyName("approveTypeName")] public string ApproveTypeName { get; set; }

    [JsonPropertyName("apiClientId")] public string ApiClientId { get; set; }

    [JsonPropertyName("apiClientSecret")] public string ApiClientSecret { get; set; }
    ...
    [JsonPropertyName("createUserId")] public string CreateUserId { get; set; }
    ...
    [JsonPropertyName("templates")] public List<OutSideBpmApproveTemplateVo> Templates { get; set; }

    [JsonPropertyName("isUsed")] public bool? IsUsed { get; set; }
