...
public class BpmnTimeoutReminderVariableVo
{
    ...
    [JsonPropertyName("processNum")] public string ProcessNum { get; set; }

    [JsonPropertyName("processName")] public string ProcessName { get; set; }

    [JsonPropertyName("processDesc")] public string ProcessDesc { get; set; }
    ...
    [JsonPropertyName("processinessKey")] public string ProcessinessKey { get; set; }
    ...
    [JsonPropertyName("approvalEmpl")] public string ApprovalEmpl { get; set; }

    [JsonPropertyName("applyDate")] public string ApplyDate { get; set; }

    [JsonPropertyName("applyTime")] public string ApplyTime { get; set; }
