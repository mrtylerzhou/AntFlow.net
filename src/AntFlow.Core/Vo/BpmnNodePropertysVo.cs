...
{
    [JsonPropertyName("loopEndType")] public int? LoopEndType { get; set; }

    [JsonPropertyName("loopNumberPlies")] public int? LoopNumberPlies { get; set; }

    [JsonPropertyName("loopEndGrade")] public int? LoopEndGrade { get; set; }
    ...
    [JsonPropertyName("assignLevelType")] public int? AssignLevelType { get; set; }

    [JsonPropertyName("assignLevelGrade")] public int? AssignLevelGrade { get; set; }

    [JsonPropertyName("hrbpConfType")] public int? HrbpConfType { get; set; }

    [JsonPropertyName("roleIds")] public List<string> RoleIds { get; set; }

    [JsonPropertyName("roleList")] public List<BaseIdTranStruVo> RoleList { get; set; }

    [JsonPropertyName("emplIds")] public List<string> EmplIds { get; set; }

    [JsonPropertyName("emplList")] public List<BaseIdTranStruVo> EmplList { get; set; }

    [JsonPropertyName("signType")] public int? SignType { get; set; }

    [JsonPropertyName("conditionsConf")] public BpmnNodeConditionsConfBaseVo ConditionsConf { get; set; }

    [JsonPropertyName("conditionList")] public List<List<BpmnNodeConditionsConfVueVo>> ConditionList { get; set; }

    [JsonPropertyName("configurationTableType")]
    public int? ConfigurationTableType { get; set; }

    [JsonPropertyName("tableFieldType")] public int? TableFieldType { get; set; }

    [JsonPropertyName("isMultiPeople")] public int? IsMultiPeople { get; set; }
    ...
    [JsonPropertyName("functionId")] public long? FunctionId { get; set; }
