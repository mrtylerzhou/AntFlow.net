...
public class BpmnTemplateVo
{
    ...
    [JsonPropertyName("informs")] public string Informs { get; set; }

    [JsonPropertyName("informIdList")] public List<string> InformIdList { get; set; }

    [JsonPropertyName("informList")] public List<BaseIdTranStruVo> InformList { get; set; }

    [JsonPropertyName("emps")] public string Emps { get; set; }

    [JsonPropertyName("empIdList")] public List<string> EmpIdList { get; set; }

    [JsonPropertyName("empList")] public List<BaseIdTranStruVo> EmpList { get; set; }

    [JsonPropertyName("roles")] public string Roles { get; set; }

    [JsonPropertyName("roleIdList")] public List<string> RoleIdList { get; set; }

    [JsonPropertyName("roleList")] public List<BaseIdTranStruVo> RoleList { get; set; }

    [JsonPropertyName("funcs")] public string Funcs { get; set; }

    [JsonPropertyName("funcIdList")] public List<string> FuncIdList { get; set; }

    [JsonPropertyName("funcList")] public List<BaseIdTranStruVo> FuncList { get; set; }
