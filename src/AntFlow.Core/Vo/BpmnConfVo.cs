...
public class BpmnConfVo
{
    ...
    [JsonPropertyName("effectiveStatus")] public int EffectiveStatus { get; set; }
    ...
    [JsonPropertyName("createUserName")] public string CreateUserName { get; set; }

    [JsonPropertyName("createUserUuid")] public string CreateUserUuid { get; set; }
    ...
    [JsonPropertyName("nodes")] public List<BpmnNodeVo> Nodes { get; set; }

    [JsonPropertyName("viewPageButtons")] public BpmnViewPageButtonBaseVo ViewPageButtons { get; set; }
    ...
    [JsonPropertyName("businessPartyIds")] public List<long> BusinessPartyIds { get; set; }

    [JsonPropertyName("type")] public int Type { get; set; }

    [JsonPropertyName("lfFormData")] public string LfFormData { get; set; }

    [JsonPropertyName("lfFormDataId")] public long? LfFormDataId { get; set; }

    [JsonPropertyName("formCodeDisplayName")]
    public string FormCodeDisplayName { get; set; }

    [JsonPropertyName("extraFlags")] public int? ExtraFlags { get; set; }
}