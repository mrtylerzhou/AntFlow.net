...
{
    [JsonPropertyName("verifyInfoList")] public List<BpmVerifyInfoVo> VerifyInfoList { get; set; }
    ...
    [JsonPropertyName("startUserId")] public string StartUserId { get; set; }
    ...
    [JsonPropertyName("options")] public List<ProcessActionButtonVo> Options { get; set; }

    [JsonPropertyName("appBelowOptions")] public List<ProcessActionButtonVo> AppBelowOptions { get; set; }
    ...
    [JsonPropertyName("pcButtons")] public Dictionary<string, List<ProcessActionButtonVo>> PcButtons { get; set; }
    ...
    [JsonPropertyName("isCustomNode")] public bool? IsCustomNode { get; set; }
