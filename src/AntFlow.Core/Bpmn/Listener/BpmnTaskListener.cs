...
public class BpmnTaskListener : ITaskListener
{
    ...
    public void Notify(BpmAfTask delegateTask, string eventName)
    {
        ...
        {
            BpmProcessForward bpmProcessForward = new()
            {
        ...
        BpmVariableMessageVo bpmVariableMessageVo = new()
        {
        ...
        {
            ProcessInforVo processInforVo = new()
            {
                ProcessinessKey = bpmnCode, BusinessNumber = processNumber, FormCode = formCode, Type = 2
            };
            string emailUrl =
                _processBusinessContansService.GetRoute(ProcessNoticeEnum.EMAIL_TYPE.Code, processInforVo, isOutside);
            string appUrl =
                _processBusinessContansService.GetRoute(ProcessNoticeEnum.EMAIL_TYPE.Code, processInforVo, isOutside);
            ActivitiBpmMsgVo activitiBpmMsgVo = new()
            {
