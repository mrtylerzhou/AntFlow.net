...
public static class LinqExtensions
{
    ...
    public static Expression<Func<T1, T2, bool>> And<T1, T2>(this Expression<Func<T1, T2, bool>> first,
        Expression<Func<T1, T2, bool>> second)
    {
        return first.Compose(second, Expression.AndAlso);
    }

    public static Expression<Func<T1, T2, T3, bool>> And<T1, T2, T3>(this Expression<Func<T1, T2, T3, bool>> first,
    ...
    /// <returns></returns>
    public static Expression<Func<T, bool>> WhereIf<T>(this Expression<Func<T, bool>> source, bool condition,
        Expression<Func<T, bool>> predicate)
    {
        return condition ? source.And(predicate) : source;
    }

    public static Expression<Func<T1, T2, bool>> WhereIf<T1, T2>(this Expression<Func<T1, T2, bool>> source,
        bool condition, Expression<Func<T1, T2, bool>> predicate)
    {
        return condition ? source.And(predicate) : source;
    }

    public static Expression<Func<T1, T2, T3, bool>> WhereIf<T1, T2, T3>(this Expression<Func<T1, T2, T3, bool>> source,
        bool condition, Expression<Func<T1, T2, T3, bool>> predicate)
    {
        return condition ? source.And(predicate) : source;
    }
