...
public static class ProcessEnum
{
    ...
    public static readonly ProcessItem EntrustType = new(5, "委托流程");
    public static readonly ProcessItem SuperType = new(6, "超级管理员流程");

    /**
     * process type
     */
    public static readonly ProcessItem HostType = new(7, "主办流程");

    public static readonly ProcessItem RevokeType = new(8, "撤销流程");
    public static readonly ProcessItem WithdrawType = new(9, "撤回流程");
    public static readonly ProcessItem NoticeType = new(10, "通知流程");
    public static readonly ProcessItem CirculateStartType = new(11, "传阅流程");
    ...
    {
        return CodeToDescMap.TryGetValue(code, out string? desc) ? desc : null;
    }
...
public class ProcessItem
{
    ...
    [JsonPropertyName("desc")] public string Desc { get; }
}