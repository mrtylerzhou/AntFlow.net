...
public enum NodeTypeEnum
{
    ...
    NODE_TYPE_OUT_SIDE_CONDITIONS = 5, // 外部方条件节点
...
public class NodeTypeEnumExtensions
{
    ...
    public static string GetDesc(NodeTypeEnum nodeType)
    {
        switch (nodeType)
        {
            ...
            case NodeTypeEnum.NODE_TYPE_OUT_SIDE_CONDITIONS: return "外部方条件节点";
    ...
    {
        List<NodeTypeEnum>? nodeTypeEnums = GetNodeTypesWithPropertyTable();
