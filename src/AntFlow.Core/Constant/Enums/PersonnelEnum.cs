...
{
    private static readonly Dictionary<PersonnelEnum, (NodePropertyEnum NodeProperty, string Description)>
        PersonnelMappings =
            new()
            {
                { PersonnelEnum.NODE_LOOP_PERSONNEL, (NodePropertyEnum.NODE_PROPERTY_LOOP, "循环人员") },
                { PersonnelEnum.NODE_LEVEL_PERSONNEL, (NodePropertyEnum.NODE_PROPERTY_LEVEL, "指定层级人员") },
                ...
                { PersonnelEnum.CUSTOMIZABLE_PERSONNEL, (NodePropertyEnum.NODE_PROPERTY_CUSTOMIZE, "自定义选择") },
                { PersonnelEnum.HRBP_PERSONNEL, (NodePropertyEnum.NODE_PROPERTY_HRBP, "HRBP") },
                {
                    PersonnelEnum.OUT_SIDE_ACCESS_PERSONNEL,
                    (NodePropertyEnum.NODE_PROPERTY_OUT_SIDE_ACCESS, "外部接入人员")
                },
