...
public static class ProcessSubmitStateEnumExtensions
{
    ...
    {
        (ProcessSubmitStateEnum.PROCESS_SUB_TYPE, "流程提交状态"), (ProcessSubmitStateEnum.PROCESS_AGRESS_TYPE, "流程同意状态"),
        (ProcessSubmitStateEnum.PROCESS_NO_AGRESS_TYPE, "流程不同意状态"),
        (ProcessSubmitStateEnum.WITHDRAW_AGRESS_TYPE, "流程撤回状态"), (ProcessSubmitStateEnum.END_AGRESS_TYPE, "流程作废状态"),
        (ProcessSubmitStateEnum.CRMCEL_AGRESS_TYPE, "流程终止状态"),
        (ProcessSubmitStateEnum.WITHDRAW_DISAGREE_TYPE, "back"),
        (ProcessSubmitStateEnum.PROCESS_UPDATE_TYPE, "打回修改"), (ProcessSubmitStateEnum.PROCESS_SIGN_UP, "加批")
    };
