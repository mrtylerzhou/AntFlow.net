...
namespace AntFlowCore.Api.controller;
 ...
 [Route("outSideBpm")]
    public class OutSideBpmBusinessController
    {
        ...
        private readonly IOutSideBpmApproveTemplateService _outSideBpmApproveTemplateService;
        ...
        public OutSideBpmBusinessController(
            ...
            IOutSideBpmApproveTemplateService outSideBpmApproveTemplateService)
        {
