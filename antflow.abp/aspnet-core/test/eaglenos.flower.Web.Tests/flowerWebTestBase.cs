...
public abstract class flowerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static flowerWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(flowerWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<flowerDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<flowerDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<flowerDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<flowerDbContext, Task<T>> func)
    {
        T result;
