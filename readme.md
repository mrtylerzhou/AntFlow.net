...
>
> 一位大佬说,你这玩意有啥用?别像demo里一样只能做个请假流程?大佬在本项目仓库还没有开源的时候就关注了，一直鼓励我并提供技术支持。大佬是想让我做的更好，不要只浅尝辄止。感谢大佬的鼓励和支持，也感谢大家的批评，指正，督促和监督
>
> 实际上，请假流程可简单可复杂。请假天数不同，审批路径中出现的人就不一样；如果请假是多天，请假的类型可能是混合的，怎么抵扣？用户请假了，屏蔽考勤系统发出的旷工提醒；如果提前销假了，又提一个销假流程，两个之间如何联动？他请假过程中如果有流程需要他审批，如何处理？请假流程通过扣除调休；请假流程通过后又撤回不请了，把调休天数还给他。请假撤销后如何撤销考勤系统已经放开的考勤约束？
