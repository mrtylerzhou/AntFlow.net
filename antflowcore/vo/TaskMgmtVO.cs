...
namespace AntFlowCore.Vo
{
    public class TaskMgmtVO
    {
        ...
        public int ConcernState { get; set; }
        ...
        public string OvertimeUrl { get; set; }

        [JsonPropertyName("isLeftStroke")]
        public bool IsLeftStroke { get; set; }

        [JsonPropertyName("title")]
        public string Title { get; set; }

        [JsonPropertyName("isBatchSubmit")]
        public bool IsBatchSubmit { get; set; }
        ...
        public List<ContansDataVo> ChangeHandlers { get; set; }
        ...
        public int DoneCreateCount { get; set; }
        ...
        public List<string> ProcessNumbers { get; set; }
