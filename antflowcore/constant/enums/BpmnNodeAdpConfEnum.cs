...
public enum BpmnNodeAdpConfEnum
{
    ...
    ADP_CONF_NODE_PROPERTY_APPROVED_USERS = 16,
    ADP_CONF_NODE_PROPERTY_UDR_USERS = 17,
}
...
public static class BpmnNodeAdpConfEnumExtensions
{
    ...
    private static readonly Dictionary<BpmnNodeAdpConfEnum, Enum> MappingsDictionary = new()
    {
        ...
        {BpmnNodeAdpConfEnum.ADP_CONF_NODE_PROPERTY_APPROVED_USERS, NodePropertyEnum.NODE_PROPERTY_APPROVED_USERS},
